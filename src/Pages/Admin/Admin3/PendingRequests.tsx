...
import { fetchAdmin3Pending, fetchAdminProfile } from "@/Services/Admin"
import IITLoader from "@/components/IITLoader"
import { auth } from "@/Firebase/config"
import { Button } from "@/components/ui/button"
import { useNavigate } from "react-router-dom"

const Admin3PendingRequests = () => {
  ...
  const { data: pendingRequestData = [], isLoading: requestLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const idToken = await currentUser.getIdToken();
      return fetchAdmin3Pending(adminId, idToken);
    },
    retry: false, 
    retryOnMount: false,
  });
...
export default Admin3PendingRequests