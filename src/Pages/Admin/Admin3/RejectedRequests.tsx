...
import { fetchAdmin3Rejected, fetchAdminProfile } from "@/Services/Admin"
import IITLoader from "@/components/IITLoader"
import { auth } from "@/Firebase/config"

const Admin3RejectedRequests = () => {
    // Fetch admin profile
    ...
    const { data: rejectedRequestData = [], isLoading: requestLoading } = useQuery({
        ...
        queryFn: async () => {
            ...
            const idToken = await currentUser.getIdToken();
            return fetchAdmin3Rejected(adminId, idToken);
        },
        retry: false, 
        retryOnMount: false,
    });
...
export default Admin3RejectedRequests