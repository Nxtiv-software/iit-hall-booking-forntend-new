...
import { fetchAdmin5Rejected, fetchAdminProfile } from "@/Services/Admin"
import IITLoader from "@/components/IITLoader"
import { auth } from "@/Firebase/config"
import { Button } from "@/components/ui/button"
import { useNavigate } from "react-router-dom"

const Admin5RejectedRequests = () => {
    ...
    const { data: rejectedRequestData = [], isLoading: requestLoading } = useQuery({
        ...
        queryFn: async () => {
            ...
            const idToken = await currentUser.getIdToken();
            return fetchAdmin5Rejected(adminId, idToken);
        },
        retry: false, 
        retryOnMount: false,
    });
...
export default Admin5RejectedRequests