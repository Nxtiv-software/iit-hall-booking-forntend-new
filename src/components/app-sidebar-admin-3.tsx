  ...
  navMain: [
    {
      title: "Menu",
      items: [
        { title: "Dashboard", url: "/admin3-dashboard", isActive: true},
        { title: "Requests", 
          url: "/admin3-requests-pending",
          items: [
            { title: "Pending Requests", url: "/admin3-requests-pending" },
            // { title: "Accepted Requests", url: "/admin-requests-accepted" },
            { title: "Rejected Requests", url: "/admin3-requests-rejected" },
          ] 
        }, 
