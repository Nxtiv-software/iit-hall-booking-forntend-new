  ...
  navMain: [
    {
      title: "Menu",
      items: [
        { title: "Dashboard", url: "/admin5-dashboard", isActive: true},
        { title: "Requests", 
          url: "/admin5-requests-pending",
          items: [
            { title: "Pending Requests", url: "/admin5-requests-pending" },
            { title: "Rejected Requests", url: "/admin5-requests-rejected" },
          ] 
        }, 
...
export function AppSidebar5({ ...props }: React.ComponentProps<typeof Sidebar>) {
