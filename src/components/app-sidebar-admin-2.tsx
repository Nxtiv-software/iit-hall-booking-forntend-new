  ...
  navMain: [
    {
      title: "Menu",
      items: [
        { title: "Dashboard", url: "/admin2-dashboard", isActive: true},
        { title: "Requests", 
          url: "/admin2-requests-pending",
          items: [
            { title: "Pending Requests", url: "/admin2-requests-pending" },
            // { title: "Accepted Requests", url: "/admin-requests-accepted" },
            { title: "Rejected Requests", url: "/admin2-requests-rejected" },
          ] 
        }, 
