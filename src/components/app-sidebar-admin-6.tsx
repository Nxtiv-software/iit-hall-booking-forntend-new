  ...
  navMain: [
    {
      title: "Menu",
      items: [
        { title: "Dashboard", url: "/admin6-dashboard", isActive: true},
        { title: "Requests", 
          url: "/admin6-requests-pending",
          items: [
            { title: "Pending Requests", url: "/admin6-requests-pending" },
            { title: "Rejected Requests", url: "/admin6-requests-rejected" },
          ] 
        }, 
...
export function AppSidebar6({ ...props }: React.ComponentProps<typeof Sidebar>) {
