  ...
  navMain: [
    {
      title: "Menu",
      items: [
        { title: "Dashboard", url: "/admin4-dashboard", isActive: true},
        { title: "Requests", 
          url: "/admin4-requests-pending",
          items: [
            { title: "Pending Requests", url: "/admin4-requests-pending" },
            { title: "Rejected Requests", url: "/admin4-requests-rejected" },
          ] 
        }, 
...
export function AppSidebar4({ ...props }: React.ComponentProps<typeof Sidebar>) {
